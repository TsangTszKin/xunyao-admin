    ...
    methods: {
          ...
          if (this.dataForm.id) {
            this.$http({
              ...
              if (data && data.code === 0) {
                ...
                this.dataForm.createDate = data.tproduct.createDate
                this.dataForm.updateBy = data.tproduct.updateBy
                this.dataForm.updateDate = data.tproduct.updateDate
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/admin/product/${!this.dataForm.id ? 'save' : 'update'}`),
              method: 'put',
