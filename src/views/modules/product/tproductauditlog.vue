  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <!-- <el-button v-if="isAuth('generator:tproductauditlog:save')" type="primary" @click="addOrUpdateHandle()">新增</el-button>
        <el-button v-if="isAuth('generator:tproductauditlog:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">批量删除</el-button>-->
      </el-form-item>
    </el-form>
    <el-table
      :data="dataList"
    ...
    >
      ...
      <el-table-column prop="shopId" header-align="center" align="center" label="商家id"></el-table-column>
      <el-table-column prop="productId" header-align="center" align="center" label="商品id"></el-table-column>
      <el-table-column
        prop="status"
        header-align="center"
        align="center"
        label="审核状态(1：审核通过 2：审核不通过)"
      ></el-table-column>
      <el-table-column prop="content" header-align="center" align="center" label="审核内容"></el-table-column>
      ...
      <el-table-column fixed="right" header-align="center" align="center" width="150" label="操作">
        <template slot-scope="scope">
          <el-button type="text" size="small" @click="audit(scope.row.id, 1)">通过</el-button>
          <el-button type="text" size="small" @click="audit(scope.row.id, 2)">不通过</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
...
<script>
import AddOrUpdate from './tproductauditlog-add-or-update'
export default {
  data() {
    return {
      dataForm: {
