<template>
  <div class="mod-config">
    ...
    >
      ...
      <el-table-column prop="name" header-align="center" align="center" label="活动名称"></el-table-column>
      <el-table-column prop="startTime" header-align="center" :formatter="dateFormat" align="center" label="开始时间"></el-table-column>
      <el-table-column prop="endTime" header-align="center" :formatter="dateFormat" align="center" label="结束时间"></el-table-column>
      ...
      <!-- <el-table-column prop="cashRequired" header-align="center" align="center" label="是否减现金" >
        <template slot-scope="scope">
          <el-tag v-if="scope.row.cashRequired === 0" size="small" type="danger">否</el-tag>
          <el-tag v-else size="small">是</el-tag>
        </template>
      </el-table-column>
      <el-table-column prop="cash" header-align="center" align="center" label="减多少现金"></el-table-column>
      <el-table-column prop="postage" header-align="center" align="center" label="是否包邮" >
        <template slot-scope="scope">
          <el-tag v-if="scope.row.cashRequired === 0" size="small" type="danger">不包邮</el-tag>
