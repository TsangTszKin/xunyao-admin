<template>
  <div class="mod-config">
    ...
    >
      ...
      <el-table-column prop="pic" header-align="center" align="center" label="广告图片"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      let urlForIndex = '/other/tadvert/indexList';
      let urlForIShop = '/other/tadvert/shopList';
      this.$http({
        url: this.$http.adornUrl(this.$route.params.type === 'index' ? urlForIndex : urlForIShop),
        method: 'get',
