<template>
  <div class="mod-config">
    ...
    >
      ...
      ></el-table-column>
      <el-table-column prop="drugLicensing" header-align="center" align="center" label="药品经营许可"></el-table-column>
      <el-table-column prop="businessLicense" header-align="center" align="center" label="营业执照"></el-table-column>
      <el-table-column prop="drugQuality" header-align="center" align="center" label="药品经营质量管理规范"></el-table-column>
      <el-table-column
